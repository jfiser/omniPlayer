...
===========================================
mySpy allows you to see the values of any property (private and public) of any class.
If you want to use mySpy (and why wouldn't you?) you must do 2 things:

1. Include the file "mySpyInclude.as" in your code like this:

include "mySpyInclude.as";

I usually stick it at the bottom of the class

2. Call the setClassArr function
passing an array of the classes you want to watch like this:

var classArr:Array = 
		new Array({instanceName:"ctlBtns", instance:ctlBtns},
			{instanceName:"omniHandler", instance:omniHandler},
			{instanceName:"localityHandler", instance:localityHandler},
			{instanceName:"adPolicyHandler", instance:adHandler.adPolicyHandler},
			{instanceName:"docRoot", instance:this},
			{instanceName:"main", instance:this}
			);

"instanceName" is just a string version of the actual instance.
Notice for the instance field you must give the full path to the instance:
instance:adHandler.adPolicyHandler
*****************************/
...
private var START_X:Number = 25;
private var START_Y:Number = 50;
private var START_W:Number = 200;
private var START_H:Number = 50;

function Tracer(_docRoot:Object, _reason:String, _version:String){
	docRoot = _docRoot;
	reason = _reason;
	appVersion = _version;
